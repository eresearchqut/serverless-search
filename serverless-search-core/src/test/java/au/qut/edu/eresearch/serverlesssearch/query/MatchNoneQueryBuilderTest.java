...
public class MatchNoneQueryBuilderTest {
    ...
    public void coerces() {
        ...
        Map<String, Object> queryStringQuery = Map.of("match_none", Collections.EMPTY_MAP);
        QueryBuilder queryBuilder = OBJECT_MAPPER.convertValue(queryStringQuery, QueryBuilder.class);
        Assertions.assertTrue(queryBuilder instanceof MatchNoneQueryBuilder);
